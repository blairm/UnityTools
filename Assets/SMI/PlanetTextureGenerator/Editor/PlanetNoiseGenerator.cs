...
namespace SMI.PlanetTextureGenerator.Editor
{
	...
	{
		public const string	computeShaderPath		= "Assets/SMI/PlanetTextureGenerator/Editor/PlanetNoiseGenerator.compute";
		...
		public void createNoise( int seedSurface, int seedLand, int seedLandColour01, int seedLandColour23, int seedCity, int seedCloud )
		{
			...
			if( noiseComputeShader == null )
			{
				...
				if( SystemInfo.supportsComputeShaders )
				{
					...
					noiseComputeShader	= AssetDatabase.LoadAssetAtPath< ComputeShader >( computeShaderPath );
